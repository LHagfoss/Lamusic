...
export default function HomeScreen() {
    ...
    const { useRecentSongs, useArtists, useLibrary, usePlayHistory } =
        useMusic();
    ...
    const onRefresh = React.useCallback(async () => {
        ...
        setRefreshing(false);
    }, [refetchSongs, refetchArtists, refetchLibrary, refetchHistory]);
    ...
    return (
        ...
        >
            ...
            {(loadingHistory || (playHistory && playHistory.length > 0)) && (
                <View className="mb-6">
